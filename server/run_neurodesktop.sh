...
if [ ! "$(sudo docker ps -a -q -f name=$container_name)" ]; then
	 ...
	 echo "Please enter your UPPMAX project user name (leave empty to skip):"
	 read wharf_id
	 if [ $wharf_id ]; then
            ...
            echo "Please enter your two-factor credentials for UPPMAX:"
            sshfs $wharf_id@bianca-sftp.uppmax.uu.se:$wharf_id $wharf_mount \
